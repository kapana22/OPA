...
ერთი ტელეფონი, მთელი კომპანია. **19 თამაში**, სრულად ოფლაინ,
ქართულად. React Native / Expo SDK 57.

პორტია `../Splash`-ის (SwiftUI, 28,276 ხაზი). ძრავებისა და კონტენტის
ლოგიკა ერთი-ერთზეა გადმოტანილი — იხ. `../ROADMAP-RN.md`.
...
```bash
npm test                # 71 ტესტი — სუფთა ლოგიკა, ტელეფონი არ სჭირდება
npx tsc --noEmit
```
